...
class PolicyRAGConfig:
    chunk_path: str | Path = "chunk_already.json"
...
def get_cached_agent_pipeline(
    chunk_path: str = "chunk_already.json",
...
def main() -> int:
    ...
    parser.add_argument("--chunk-path", default="chunk_already.json", help="Path to the parsed policy chunk JSON.")
    parser.add_argument(
        "--persist-dir",
