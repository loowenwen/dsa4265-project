...
from app.services.ingestion.adapters.base import InputAdapter, ParsedApplicantInput
...
class FormInputAdapter(InputAdapter):
    ...
    def _parse_fraction_or_percent(value: str | None) -> float | None:
        ...
        from app.services.ingestion.normalizer import _extract_single_number
